$(function(){
	$.post("/Article/getClassifyArticlelistByCid.html", { "currentpage": 1, "numberpage": 10 ,"cl_id":$("#classifyId").val()},function(data){
		var pojo=eval("("+data+")");
			...
			layui.use(['laypage', 'layer'], function(){
				...
				laypage.render({
					elem: 'demo0'
						...
						,jump: function(obj){
							$.post("/Article/getClassifyArticlelistByCid.html", { "currentpage": obj.curr, "numberpage": obj.limit,"cl_id":$("#classifyId").val()},function(kind){
								var Num=""; 
								for(var i=0;i<10;i++) 
								{ 
								...
								$("#blogsbox_skillalertlist").html(articlelist); 
							});
						}
				});
			});
		}else{
			$(".blogsbox").html("暂无文章(-_-)～ ");
		}
	});
});