$(function(){
	$.post("/Article/GetArticleListByClassifyId.html", { "currentpage": 1, "numberpage": 10 ,"cl_category":1},function(data){
		var pojo=eval("("+data+")");
		layui.use(['laypage', 'layer'], function(){
			  ...
			  laypage.render({
			    ...
			    ,jump: function(obj){
			    	$.post("/Article/GetArticleListByClassifyId.html", { "currentpage": obj.curr, "numberpage": obj.limit,"cl_category":1},function(kind){
			    		var Num=""; 
			    		for(var i=0;i<10;i++) 
			    		{ 
