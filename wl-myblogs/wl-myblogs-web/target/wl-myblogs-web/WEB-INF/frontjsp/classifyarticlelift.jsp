...
<title>惠眼个人博客 - 一个在java开发之路上奋斗的程序员个人博客网站</title>
...
<div class="pagebg lift"></div>
<div class="container">
  <h1 class="t_nav"><span>慢生活，不是懒惰，放慢速度不是拖延时间，而是让我们在生活中寻找到平衡。</span><a href="/" class="n1">网站首页</a><a href="javascript:void(0);" class="n2">慢生活</a></h1>
  <!--blogsbox begin-->
  <input id="classifyId" type="hidden" value="${cId }">
  <div class="blogsbox">
  	<div id="blogsbox_skillalertlist">
    </div>
    <!--分页插件-->
    <div id="demo0"></div>
  </div>
...
<script type="text/javascript" src="/front/frontjs/classifyarticlelist.js"></script>
